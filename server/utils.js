    ...
    return {
		...
		markovChain: function(type) {
		    ...
		    if (chain = this.chainCache[type]) {
		      ...
		      var list; if (list = this.nameSet[type]) {
		        var chain; if (chain = this.constructChain(list)) {
